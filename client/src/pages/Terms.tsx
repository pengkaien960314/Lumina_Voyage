...
const sections = [
  { title: "1. 服務說明", content: "Wanderlust 提供旅行規劃、景點瀏覽、旅遊日記、旅館預訂、機票查詢、翻譯、匯率換算、天氣查詢及導航等綜合旅行服務。本平台為資管系專題作品，部分功能為模擬展示，實際預訂服務需透過合作夥伴完成。" },
  ...
  { title: "4. 內容所有權", content: "您在 Wanderlust 上發布的旅遊日記、照片及評論等內容，其智慧財產權歸您所有。但您授予我們非獨占性、全球性的使用許可，允許我們在平台上展示、分發及推廣您的內容。您可隨時刪除您發布的內容。" },
  { title: "5. 預訂條款", content: "透過本平台進行的旅館及機票預訂，受各合作夥伴之條款約束。取消及退款政策依各服務提供者規定辦理。Wanderlust 作為平台中介，不對預訂服務的品質或結果承擔直接責任，但將協助處理相關爭議。" },
  { title: "6. 免責聲明", content: "本服務按「現狀」提供，我們不對服務的不間斷性、及時性、安全性或無錯誤性作出保證。天氣、匯率等即時資訊僅供參考，不構成任何形式的建議。使用者應自行判斷並承擔使用本服務的風險。" },
  { title: "7. 責任限制", content: "在法律允許的最大範圍內，Wanderlust 及其團隊成員不對因使用或無法使用本服務而產生的任何直接、間接、附帶或衍生性損害承擔責任，包括但不限於利潤損失、資料遺失或商譽損害。" },
      ...
      <section className="py-10 flex-1">
        <div className="container max-w-3xl">
          <p className="text-muted-foreground mb-8 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
            歡迎使用 Wanderlust 旅行探索平台。請在使用我們的服務前仔細閱讀以下條款。使用本服務即表示您同意遵守本服務條款。
          </p>
