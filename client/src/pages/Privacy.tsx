...
const sections = [
  { title: "1. 資料收集", content: "我們收集您在使用 Wanderlust 服務時主動提供的資訊，包括但不限於：帳號註冊資訊（姓名、電子郵件、電話號碼）、旅行偏好設定、行程規劃內容、旅遊日記文字與照片、預訂記錄等。我們也會自動收集裝置資訊、IP 位址、瀏覽器類型及使用行為數據，以改善服務品質。" },
  { title: "2. 資料使用", content: "您的個人資料將用於：提供及改善我們的旅行服務、處理預訂與交易、發送服務通知與更新、個人化推薦內容、分析使用趨勢以優化產品體驗。我們不會將您的個人資料出售給第三方。" },
  { title: "3. 資料分享", content: "在以下情況下，我們可能會分享您的資訊：經您明確同意時、與合作夥伴（如航空公司、飯店）完成預訂服務時、遵守法律要求或政府機關合法請求時、保護 Wanderlust 及其用戶的權益與安全時。" },
  ...
  { title: "7. 兒童隱私", content: "Wanderlust 的服務不針對 13 歲以下的兒童。我們不會故意收集未滿 13 歲兒童的個人資訊。如果我們發現已收集到兒童的資料，將立即採取措施刪除相關資訊。" },
      ...
      <section className="py-10 flex-1">
        <div className="container max-w-3xl">
          <p className="text-muted-foreground mb-8 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
            Wanderlust（以下簡稱「我們」）非常重視您的隱私權。本隱私政策說明我們如何收集、使用、儲存及保護您的個人資訊。使用我們的服務即表示您同意本政策所述之資料處理方式。
          </p>
